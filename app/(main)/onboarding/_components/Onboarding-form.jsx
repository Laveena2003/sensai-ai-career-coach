...
const OnboardingForm = ({ industries }) => {
  ...
  const onSubmit = async (values) => {
    try {
      const industryObj = industries.find(ind => ind.id === values.industry);
      const formattedIndustry = `${industryObj?.name || values.industry}-${values.subIndustry
        .toLowerCase()
        .replace(/ /g, "-")}`;
  ...
  }, [updateResult?.success, updateLoading, router]);
